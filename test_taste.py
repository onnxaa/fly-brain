"""Shiu replication on rate: sugar/bitter/water -> MN9 + ranking; sugar+bitter vs sugar (Fig3 interaction)."""
...
# MN9 act from EFFERENT? MN9 is motor: take h directly
for name in ["sugar", "bitter", "water"]:
...
# interaction: sugar + bitter (second simultaneous drive) vs sugar alone
...
print(f"sugar MN9={hS[mn9]:.3f} | sugar+bitter MN9={hSB[mn9]:.3f} (Shiu: bitter suppresses -> expect drop)", flush=True)
